    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = {
                        ctx.navController.navigate(Main)
                    }) {
                        Icon(
        ...
        Box(
            ...
            LazyColumn(
                ...
                // Add 5 items
                items(5) { index ->
                    ConfigRow(ctx.context, "", "Item: $index", index == 2)
                }
            }
        }
    }
...
@Composable
fun ConfigRow(ctx: Context, key: String, name: String, selected: Boolean) {
    Row(
                    ...
                    onClick = {
                        ...
                        AlertDialog.Builder(ctx)
                            ...
                            .setPositiveButton("删除", DialogInterface.OnClickListener { dialog, which ->
                                Toast.makeText(ctx, "todo deleted", Toast.LENGTH_SHORT)
                                    .show()
                            })
